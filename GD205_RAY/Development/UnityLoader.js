...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'GD205_RAY.data';
    var REMOTE_PACKAGE_BASE = 'GD205_RAY.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 8689164;
      var PACKAGE_UUID = '44e887cc-8b0b-4239-a131-a401670ffd00';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 5278993, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(5278993, 5279014, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(5279014, 7164846, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(7164846, 8661538, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(8661538, 8689164, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_GD205_RAY.data');

    };
    Module['addRunDependency']('datafile_GD205_RAY.data');
